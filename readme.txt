...
Plugin URL: http://www.dizzyd.net
Description: Adds ability to upload images and choose where they link, having them display randomly in a given area.
Tags: advertisements, rotating image, rotating link, random image, random link
Stable tag: 1.2
Author: David Wood
Author URL: http://www.dizzyd.net
...
This is a very light weight and simple plugin with multiple uses. Works with virtually any Wordpress Installation regardless of the version.
<strong>This is perfect for simple advertisement banners, or a random image with catchy text that leads the reader to another page on your site/blog, random facts, random articles, random products.</strong>



==Installation==
* Simply upload the randomlinkedimage.php file via the plugin manager in the wp-admin panel. 
* Activate the plugin, then access the RLI Manage menu inside the SETTINGS tab.
